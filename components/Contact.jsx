          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="flex items-center gap-5 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm hover:border-blue-500/30 transition-all group">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-[10px] font-medium leading-tight">Boulevard de l'Anfa, Maarif, Casablanca</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm hover:border-blue-500/30 transition-all group">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-4">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-[10px] font-bold">Support: 212 661 00 00 00</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm hover:border-blue-500/30 transition-all group">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-[10px] font-bold">support@techzone.ma / pro@techzone.ma</p>
              </div>
            </div>
          </div>
