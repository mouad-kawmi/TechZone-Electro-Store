...
const EmptyState = ({
    ...
    const configs = {
        cart: {
            icon: ShoppingBag,
            title: 'Panier Khawi',
            message: 'Ma fih 7ta chi 7aja dork. Dreb chi doura w chouf chno khasek!',
            action: 'Commencer le Shopping'
        },
        wishlist: {
            icon: Heart,
            title: 'Favoris Khawyin',
            message: 'Mazal ma derti l-qalb l-7ta chi produit. Chuf chno k-y-3jbek!',
            action: 'Explorer les Produits'
        },
        search: {
            icon: Search,
            title: 'Walo ma lqina',
            message: 'Had l-kelma ma 3tatna 7ta natija. Jereb chi kelma khra!',
            action: 'Rechercher à Nouveau'
        },
        default: {
            icon: Ghost,
            title: 'Hna khawi',
            message: 'Ma lqina 7ta chi data hna.',
