 ...
 * Gère la recherche, le panier, les favoris et la navigation
...
const Header = ({
  ...
  // Filtrage des résultats de recherche en temps réel
  ...
  const navItems = [
    ...
    { name: 'Tablets', displayName: 'Tablettes', icon: Tablet },
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`flex items-center justify-center rounded-xl hover:bg-slate-100 dark:hover:bg-white/5 text-slate-600 dark:text-slate-400 transition-colors ${isLoggedIn ? 'h-10 px-3 gap-2 w-auto' : 'size-10'}`}
              >
